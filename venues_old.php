...
$hasActiveFilters = ($location !== 'all' || $budget !== 'all' || $capacity !== 'all' || $venueType !== 'all' || trim($search) !== '');
...
<div style="background-color: var(--bg-page); min-height: 100vh; padding-top: 100px; padding-bottom: 60px;">
    <div class="container">
        <!-- Header -->
        <div class="mb-5">
            <h1 class="heading-2 mb-3">Explore All Boutique Hotels in Udaipur (500+ Stays)</h1>
